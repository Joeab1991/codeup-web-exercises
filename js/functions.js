...
alert(`Your total tip comes to ${formatter.format(calculateTip(billTotal, tipPercent))}. 
The total amount you should pay is: ${formatter.format(billTotal + tipAmount)}`);
